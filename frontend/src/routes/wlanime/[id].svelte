...
<script>
	export let id;
	import { wlanimes } from '../../stores/store';
...
<div class="flex flex-col items-center justify-center w-full max-w-lg mx-auto my-auto">
	...
	<h2 class="mt-2 text-lg text-center font-medium text-gray-900 dark:text-red-700">
		{anime.title}
	</h2>
	<h4 class="mt-2 text-lg font-medium text-center text-gray-700 dark:text-red-700">
		Release Year: {anime.releasedate.slice(0, 4)}
	</h4>
	<h4 class="mt-2 text-lg font-medium text-center  text-gray-700 dark:text-red-700">
	...
	<h4 class="mt-2 text-lg font-medium text-gray-700 text-center  dark:text-red-700">
		Genre:
